...
- 🎓 Estudando **Engenharia de Computação** na **Universidade Federal de Goiás (UFG)**.
- 🔬 Membro da **Liga Acadêmica de Automação Residencial e AIoT**.
- 🌱 Aprofundando conhecimentos em **C, Java e Python** 
- ⚡ Curiosidade: Tenho facilidade com aprendizado com entrega final de projetos rigorosa e garantida sempre.

## 🚀 Projetos e Estudos Recentes

- 🏥 **Sistema de Agendamento Médico:** Desenvolvimento e versionamento de uma aplicação em Java orientada a objetos (Repositório local: `poo-ec-2026-1/g8`).
...
## 📌 Extensão e Envolvimento Acadêmico

- 🌐 **Staff**, Conecta CEIA (2026)
- 📝 **Fiscal Auxiliar**, Instituto Verbena (2026)
- 🏫 **Monitor**, Espaço das Profissões UFG (2025)
- ⛺ **Participante Certificado**, Campus Party Goiás (2025)
